package lv.ozo.recipe_project.bootstrap;

import lv.ozo.recipe_project.domain.*;
...
// get Unit of Measure
        ...
        Optional<UnitOfMeasure> tablespoonOptimal =unitOfMeasureRepository.findByDescription("Tablespoon");
        if (!tablespoonOptimal.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
...
//        Get optionals
        ...
        UnitOfMeasure tableSpoonUom = tablespoonOptimal.get();
